...
void instr(iinfo *ii) {
  ...
  switch(opc=getch()) {
    case IL_LD:     P("\tld\t%d\n",geti()); break;
    case IL_ST:     P("\tst\t%d\n",geti()); break;
    case IL_PARLD:  P("\tparld\t%d\n",geti()); break;
    case IL_PARST:  P("\tparst\t%d\n",geti()); break;
    case IL_INDLD:  P("\tindld\t%d\n",geti()); break;
    case IL_INDST:  P("\tindst\t%d\n",geti()); break;
    case IL_ARGLD:  P("\targld\t%d\n",geti()); break;
    case IL_ARGST:  P("\targst\t%d\n",geti()); break;
    case IL_VAL:    P("\tval\t%d\n",geti()); break;
    case IL_VALN:   P("\tvaln\n"); break;
    ...
    case IL_CLOS:   { long fi=geti(); P("\tclos\t%s\t%d\n",findfun(fi,ii)->funname,geti()); }; break;
    case IL_CLOSE:  P("\tclose\t%s\n",findfun(geti(),ii)->funname); break;
    case IL_CONS:   P("\tcons\n"); break;
    case IL_HDTL:   P("\thdtl\n"); break;
    case IL_TUPLE:  P("\ttuple\t%d\n",geti()); break;
    case IL_TUPD:   P("\ttupd\t%d\n",geti()); break;
    case IL_SELF:   P("\tself\n"); break;
    case IL_PARENT: P("\tparent\n"); break;
    case IL_TTYPE:  P("\tttype\t%s\n",findfun(geti(),ii)->funname); break;
    case IL_JSR:    P("\tjsr\t%s\n",findfun(geti(),ii)->funname); break;
    case IL_JSRCL:  P("\tjsrcl\n"); break;
    case IL_JSRM:   P("\tjsrm\t%d\n",geti()); break;
    case IL_JSRME:  P("\tjsrme\t%d\n",geti()); break;
    case IL_SYS:    P("\tsys\t%d\n",geti()); break;
    case IL_LAB:    P("%d:",geti()); break;
    case IL_BRA:    P("\tbra\t%d\n",geti()); break;
    case IL_BT:     P("\tbt\t%d\n",geti()); break;
    case IL_BF:     P("\tbf\t%d\n",geti()); break;
    case IL_RET:    P("\tret\n"); break;
    case IL_JTAB:   P("\tjtab\t"); n=geti(); P("%d",n); for(i=0;i<n;i++) P(",%d",geti()); P("\n"); break;
